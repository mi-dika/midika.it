...
const translations = {
  en: {
    ...
    fetchingCompanyInfo: 'Fetching company information...',
    retrievingServices: 'Retrieving services...',
    gettingTime: 'Getting current time...',
  ...
  it: {
    ...
    privacy: 'Privacy',
    cookiePolicy: 'Cookie Policy',
    processingRequest: 'Elaborazione della tua richiesta...',
    fetchingCompanyInfo: 'Recupero informazioni aziendali...',
    retrievingServices: 'Recupero servizi...',
    gettingTime: 'Recupero ora corrente...',
